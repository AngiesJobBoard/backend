...
from ajb.contexts.companies.api_egress_webhooks.models import EgressWebhookEvent, EgressObjectType
...
class CompanyApplicantsWebhookEgress(BaseWebhookEgress):
    ...
    def send_create_applicant_webhook(self, company_id: str, application_id: str):
        ...
        application: Application = self.get_object(Collection.APPLICATIONS, application_id)
