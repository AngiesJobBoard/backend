...
SUBSCRIPTION_USAGE_COST_DETAIL_DEFAULTS: dict[
    ...
    SubscriptionPlan.SILVER: {
        UsageType.APPLICATIONS_PROCESSED: UsageDetail(
            ...
            cost_usd_per_transaction=1.0,
            blocked_after_free_tier=True,
        ),
    ...
    SubscriptionPlan.APPSUMO: {
        UsageType.APPLICATIONS_PROCESSED: UsageDetail(
            blocked_after_free_tier=True, free_tier_limit_per_month=1000
        ),
        UsageType.TOTAL_JOBS: UsageDetail(
            blocked_after_free_tier=True, free_tier_limit_per_month=20
        ),
        UsageType.TOTAL_RECRUITERS: UsageDetail(
            blocked_after_free_tier=True, free_tier_limit_per_month=10
        ),
    },
}
