...
class MixpanelService:
    ...
    def update_company_profile(self, company_id: str, properties: dict):
        if self.mp:
            self.mp.group_set(
                group_key="company_id", group_id=company_id, properties=properties
            )
...
class MixpanelDomainEvents(MixpanelService):
    ...
    def recruiter_is_invited_to_company(
        self, inviting_user_id: str, company_id: str, role: str, invitation_id: str
    ):
        properties = {
            "role": role,
        ...
        self.track(
            inviting_user_id,
            company_id,
            EventName.RECRUITER_IS_INVITED_TO_COMPANY,
            properties,
        )

    def recruiter_invitation_is_accepted(
        self, accepting_user_id: str, company_id: str, role: str, invitation_id: str
    ):
        properties = {
            "role": role,
            "invitation_id": invitation_id,
        ...
        self.track(
            accepting_user_id,
            company_id,
            EventName.RECRUITER_INVITATION_IS_ACCEPTED,
            properties,
        )

    def job_description_is_generated(
        self, user_id: str, company_id: str, generation_type: str
    ):
        properties = {
            "generation_type": generation_type,
        }
        self.track(
            user_id, company_id, EventName.JOB_DESCRIPTION_IS_GENERATED, properties
        )

    def resume_is_scanned(
        self, user_id: str, company_id: str | None, application_id: str
    ):
        properties = {
    ...
    def application_is_submitted_and_enriched(
        ...
        self.track(
            user_id,
            company_id,
            EventName.APPLICATION_IS_SUBMITTED_AND_ENRICHED,
            properties,
        )

    def job_created_from_portal(
        self, user_id: str, company_id: str, job_id: str, position_title: str | None
    ):
        properties = {
            "job_id": job_id,
    ...
    def job_created_from_api_webhook_ingress(
        self, user_id: str, company_id: str, external_reference_code: str | None
    ):
        properties = {
        ...
        self.track(
            user_id,
            company_id,
            EventName.JOB_CREATED_FROM_API_WEBHOOK_INGRESS,
            properties,
        )

    def application_created_from_api_webhook_ingress(
        self,
        user_id: str,
        company_id: str,
        external_job_reference_code: str | None,
        application_id: str,
    ):
        properties = {
        ...
        self.track(
            user_id,
            company_id,
            EventName.APPLICATION_CREATED_FROM_API_WEBHOOK_INGRESS,
            properties,
        )

    def application_created_from_portal(
        self,
        user_id: str,
        company_id: str,
        job_id: str,
        application_id: str,
        creation_type: Literal["csv", "pdf", "manual_form"],
    ):
        properties = {
            "job_id": job_id,
            "application_id": application_id,
        ...
        self.track(
            user_id, company_id, EventName.APPLICATION_CREATED_FROM_PORTAL, properties
        )

    def application_created_from_email_ingress(
        self, user_id: str, company_id: str, job_id: str, application_id: str
    ):
        properties = {
            "job_id": job_id,
    ...
    def application_status_is_updated(
        self,
        user_id: str,
        company_id: str,
        job_id: str,
    ...
    def job_forwarded_from_webhook(self, company_id: str, job_id: str):
        ...
        self.track(
            "webhook_forwarding",
            company_id,
            EventName.JOB_FORWARDED_FROM_WEBHOOK,
            properties,
        )

    def application_forwarded_from_webhook(
        ...
        self.track(
            "webhook_forwarding",
            company_id,
            EventName.APPLICATION_FORWARDED_FROM_WEBHOOK,
            properties,
        )
