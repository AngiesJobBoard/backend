...
class CompanyCountsMigrationUseCase(BaseUseCase):
    ...
    def update_company_counts(self, company: Company):
        ...
        print(f"Original Counts: {company.total_jobs}, {company.total_applicants}, {company.shortlisted_applicants}, {company.high_matching_applicants}, {company.new_applicants}")
        print(f"Updated Counts: {updated_company.total_jobs}, {updated_company.total_applicants}, {updated_company.shortlisted_applicants}, {updated_company.high_matching_applicants}, {updated_company.new_applicants}\n")
...
class JobCountsMigrationUseCase(BaseUseCase):
    ...
    def update_job_counts(self, job: Job):
        ...
        print(f"Original Counts: {job.total_applicants}, {job.shortlisted_applicants}, {job.high_matching_applicants}, {job.new_applicants}")
        print(f"Updated Counts: {updated_job.total_applicants}, {updated_job.shortlisted_applicants}, {updated_job.high_matching_applicants}, {updated_job.new_applicants}\n")
