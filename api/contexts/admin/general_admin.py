...
from ajb.contexts.companies.recruiters.models import UserCreateRecruiter, CreateRecruiter, Recruiter
...
def add_user_to_company(request: Request, payload: UserCreateRecruiter):
    return RecruiterRepository(
        request_scope=request.state.request_scope
    ).create(CreateRecruiter(**payload.model_dump()))
